...
class QuestionLoader {
    ...
    func loadQuestionsFrom(plistFileName: String) -> [Question]? {
        ...
        if let questionsPath = Bundle.main.path(forResource: plistFileName, ofType: "plist"),
           let questionObjects = NSArray(contentsOfFile: questionsPath) as? [[String: AnyObject]] {
